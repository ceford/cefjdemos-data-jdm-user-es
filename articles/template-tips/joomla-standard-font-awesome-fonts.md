...
¡El CMS de Joomla! viene con su propio juego de fuentes personalizadas de Font Awesome. Estas fuentes de íconos están disponibles por defecto para su uso en las plantillas *Cassiopeia* y *Atum*.

Los iconos de fuente que están mapeados en `/media/system/scss/_icomoon.scss` se pueden llamar con una etiqueta `name-of-icon">` y un {espacio} `</span>`. Por ejemplo:

```html
<span class="icon-joomla"> </span>
```

Mostrará el icono de Joomla!: <span class="icon-joomla">&nbsp;</span>

Los iconos de fuente que no están mapeados se pueden llamar con una etiqueta `<span class="far fa-name-of-icon">` y un {espacio} `</span>`. Ejemplo:

```php
<i class="fa fa-adjust"></i>
```

Mostrará un icono de ajuste: <i class="fa fa-adjust"></i>

## Tamaño de Fuente

Dado que los iconos son fuentes, puedes controlar su tamaño con una clase adicional o una declaración style=. Por supuesto, tendrás que definir la clase en tu archivo de hoja de estilos .css o .less.
...
Aquí está el icono de Joomla! redimensionado: <span class="icon-joomla" style="font-size:24px;">&nbsp;</span>

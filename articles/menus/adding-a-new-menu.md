...
![Lista de menús](../../../en/images/menus/adding-a-new-menu/01-menus-manage.png)
...
- En el formulario de entrada de datos del Menú, complete los siguientes campos:
  ...
  - **Descripción**: Aunque no es obligatorio, a menudo es útil en un sitio con muchos menús. Aparece debajo del *Título* en la lista de menús como se ilustra arriba.<br>
    ![Nuevo Menú](../../../en/images/menus/adding-a-new-menu/02-menus-new.png)
- **Guardar y Cerrar**
...
![Formulario de ingreso de datos del módulo del Menú](../../../en/images/menus/adding-a-new-menu/03-menus-module.png)
...
![Formulario de entrada de datos del elemento del menú](../../../en/images/menus/adding-a-new-menu/04-menus-single-article.png)
...
![Visualización del menú](../../../en/images/menus/adding-a-new-menu/05-menus-display.png)

...
![Cabeceras HTTP de Joomla 1](../../../en/images/security/http-headers/01-http-headers-dev-tools-headers.png)
...
![Cabeceras HTTP de Joomla 2](../../../en/images/security/http-headers/02-http-headers-dev-tools-headers-reject.png)
...
![Cabeceras HTTP de Joomla 3](../../../en/images/security/http-headers/03-http-headers-dev-tools-headers-not-found.png)
...
![instantánea de lindos gatitos](../../../en/images/security/http-headers/14-http-headers-plugins-headers-kittens.jpg)
...
![ataque de hombre en el medio](../../../en/images/security/http-headers/15-http-headers-plugins-headers-man-in-middle.png)
...
![información del certificado TLS](../../../en/images/security/http-headers/16-http-headers-plugins-headers-tls.png)
...
![precarga HSTS](../../../en/images/security/http-headers/17-http-headers-plugins-headers-enter-domain.png)

...
![Entrada de datos del módulo de visualización de feeds](../../../en/images/news-feeds/news-display/01-news-joomla-news-form.png)

El resultado puede ser poco atractivo, pero se puede mejorar con algunos estilos personalizados en user.css:

![Entrada de datos del módulo de visualización de feeds](../../../en/images/news-feeds/news-display/02-news-joomla-news-display.png)
...
![Entrada de datos del componente de fuente de noticias](../../../en/images/news-feeds/news-display/03-news-feed-data-entry.png)
...
![Entrada de datos del elemento de menú de fuente de noticias](../../../en/images/news-feeds/news-display/04-news-feed-menu-form.png)

Pruébalo: ve al menú del Sitio y selecciona el elemento de menú de la Fuente.

![Visualización de la fuente de noticias](../../../en/images/news-feeds/news-display/05-news-feed-display.png)
...
![Visualización personalizada de la fuente de noticias](../../../en/images/news-feeds/news-display/06-news-feed-custom-display.png)
...
![Formulario de menú de fuente de noticias por categoría](../../../en/images/news-feeds/news-display/07-news-feed-menu-category-form.png)

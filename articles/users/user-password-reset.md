<!--
{
  ...
  "title": "Restablecimiento de Contraseña de Usuario  ",
  "description": "", 
  "author": ""
}
-->
...
![módulo de inicio de sesión de usuario del sitio](../../../en/images/users/user-password-reset/01-user-site-login-module.png)
...
![formulario de restablecimiento de contraseña olvidada del sitio](../../../en/images/users/user-password-reset/02-user-forgot-password-reset.png)
...
![formulario de confirmación de contraseña olvidada del sitio](../../../en/images/users/user-password-reset/03-user-forgot-password-confirm.png)

Y finalmente, se requiere que el usuario ingrese una nueva contraseña:

![formulario de restablecimiento de contraseña olvidada del sitio](../../../en/images/users/user-password-reset/04-user-forgot-password-complete.png)
...
![formulario de edición de usuario de administradores](../../../en/images/users/user-password-reset/05-users-edit-user-john-doe.png)
